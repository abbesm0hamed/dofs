return {
  {
    ...
    config = function()
      ...
      local execs = {
        ...
        { nil, "<A-i>", "Float Terminal",      "float",      nil },
      }
      ...
      local exec_toggle = function(opts)
        ...
        local term = Terminal:new({
          ...
          scrollback = 100 -- Add scrollback limit to new terminals
        })
  ...
  augroup end
      ...
      -- custom commands on terminal
      --
      -- lazy git (should be installed in the system first)
      local Terminal = require("toggleterm.terminal").Terminal
